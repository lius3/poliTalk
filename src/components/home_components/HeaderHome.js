...
function HeaderHome(){
    ...
    return (
      ...
      <div style={{backgroundColor:"#92b7c9"}} id="mainNavbar">
        <Link style={{textDecorationLine:"none", color:"black"}} to="/"><h2 className="navElement" id="home"></h2></Link>        <Link style={{textDecorationLine:"none", color:"black"}} to="/profile"><h2 className="navElement" id="profile"></h2></Link>
        ...
        <div className="row" style={{backgroundColor:"#184f64"}}>
          ...
          <div className="col-xl-2">
            <form  className="header_button_container">
